return {
  ...
  config = function()
    ...
    vim.keymap.set("n", "<leader>ls", fzf.lsp_document_symbols, { desc = "Document symbols (fzf)" })
    vim.keymap.set("n", "<leader>lw", fzf.lsp_workspace_symbols, { desc = "Workspace symbols (fzf)" })
    vim.keymap.set("n", "<leader>ld", ":FzfLua diagnostics_document <CR>", { desc = "Document diagnostics (fzf)" })
    vim.keymap.set("n", "<leader>lD", ":FzfLua diagnostics_workspace <CR>", { desc = "Workspace diagnostics (fzf)" })
